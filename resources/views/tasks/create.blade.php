  ...
  <div>
    <div class="md:w-[400px] bg-white p-2 rounded-md">
      <div class="flex flex-col p-2">
        ...
        <input class="border-2 border-black w-60 rounded-lg p-1 " type="string" required name="name" id="name" />
      </div>
      <div class="flex flex-col p-2">
        <label for="desc" class="pb-1 ">
          Description
        </label>
        <input class="border-2 border-black w-60 rounded-lg p-1 " type="string" required id="desc" name="desc" />
      </div>
      <div class="flex flex-col p-2">
